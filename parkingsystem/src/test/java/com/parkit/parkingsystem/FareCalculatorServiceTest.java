...
// New tests regarding the Free first 30 minutes
	@Test
	...
	public void calculateFareBikeWithMoreThan30MinutesParkingTime() {
		Date inTime = new Date();
		inTime.setTime(System.currentTimeMillis() - (30 * 60 * 1000));// 30 minutes parking time should give a
																		// parking fare
		Date outTime = new Date();
		ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.BIKE, false);
    ...
    //Scenario with the Fidelity discount
    @Test
